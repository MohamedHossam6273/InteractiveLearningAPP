...
const PapyrusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
    ...
    >
        ...
        <path d="M5 22h14" />
        <path d="M12 2v20" />
        <path d="M5 2a4 4 0 0 0-4 4v12a4 4 0 0 0 4 4" />
        <path d="M19 2a4 4 0 0 1 4 4v12a4 4 0 0 1-4 4" />
    </svg>
);
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        <Link href="/" className="ml-6 flex items-center space-x-2">
          <PapyrusIcon className="h-6 w-6 text-primary" />
